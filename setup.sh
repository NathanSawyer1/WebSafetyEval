...
echo "  WEB_SAFETY_AGENT=openclaw PYTHONPATH=src python3 run_demo.py"
echo ""
echo "Or run all scenarios:"
echo "  WEB_SAFETY_AGENT=openclaw PYTHONPATH=src python3 run_all.py"
